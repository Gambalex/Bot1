...
module.exports.run = async (bot, messageReaction, user) => {
  ...
  if(messageReaction.message.id === "864241101883965480"){
  ...
  else if (messageReaction.message.id === "864241101883965480") {
  ...
  else if (messageReaction.message.id === "864241101883965480" || messageReaction.message.id === "864241101883965480") {
