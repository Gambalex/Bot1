...
module.exports.run = async (bot, message) => {
    ...
    let CantidadAP = argumentos[0].replace(prefix+"pagof",'');let Beneficiario = argumentos[1];
    ...
    let embed = new Discord.MessageEmbed()
        .setTitle("PAGO")
        .setColor(0xFF0000)
        .setThumbnail("https://files.lu-rp.ovh/static/assets/images/ordenadores/fleeca.png")
